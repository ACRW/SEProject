...
const startday=document.getElementsByName('startday');// table content 4
const endday=document.getElementsByName('endday');// table content 5
//const endday=document.getElementsByName('duration');// table content 6
/*为什么加上这个就错了？*/

const totalPrice = document.getElementsByName('totalPrice'); // table content 7
